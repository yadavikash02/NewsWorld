...
export default class Everything extends Component {
  ...
  previous = async () => {
    if (this.state.page - 1 > 0) {
      let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=e44559be7e2b4db595882caa9bc0fde8&pageSize=20&page=${this.state.page}&pageSize=20`;
      let data = await fetch(url);
      let parsedData = await data.json();
