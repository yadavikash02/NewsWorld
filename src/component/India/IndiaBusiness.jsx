...
export default class IndianBusiness extends Component {
    constructor() {
        super();
        this.state = {
          articles: [],
      ...
      async componentDidMount() {
        let url = "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=e44559be7e2b4db595882caa9bc0fde8&pageSize=20";
        ...
        this.setState({ articles: parsedData.articles,page: this.state.page,totalResults:parsedData.totalResults });
          ...
          previous =async()=>{
            if(this.state.page-1>0){
              let url = `https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=e44559be7e2b4db595882caa9bc0fde8&page=${this.state.page}&pageSize=20`;
              let data = await fetch(url);
              let parsedData =await data.json();
          ...
          render() {
            return (
              <div className="container my-3">
                <h3>India-Business Headlines</h3>
                <AutoplayNews country="in" category="business"></AutoplayNews>
